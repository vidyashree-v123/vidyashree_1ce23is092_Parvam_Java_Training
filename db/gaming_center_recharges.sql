...
CREATE TABLE `recharges` (
  ...
  CONSTRAINT `recharges_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `members` (`member_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `recharges_chk_1` CHECK ((`amount` > 0))
...
INSERT INTO `recharges` VALUES (1,1,500.00,'2025-03-05 10:30:00'),(2,2,300.00,'2025-03-06 15:45:00'),(3,1,200.00,'2025-03-07 12:10:00');
